...
public class Hotel {
	...
	@Column(name="city")
	 ...
	 private String website;
		 ...
		 // edit tostring 
			/*
			 * public BookingDetails getBookingdetails() { return bookingdetails; } public
			 * void setBookingdetails(BookingDetails bookingdetails) { this.bookingdetails
			 * =bookingdetails; } public Hotel(BookingDetails bookingdetails) { super();
			 * this.bookingdetails = bookingdetails; }
			 * 
			 * @OneToOne(MappedBy=hotels,cascade=CascadeType.ALL) private BookingDetails
			 * bookingdetails;
			 */
